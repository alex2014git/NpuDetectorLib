...
if (NOT DEFINED HAILORT_INCLUDE)
    if (UNIX)
        ...
        set(HAILORT_INCLUDE "/opt/poky/4.0.2/sysroots/armv8a-poky-linux/usr/include/hailo" CACHE PATH "Path to HailoRT include directory")
    else ()
...
if (NOT DEFINED HAILORT_LIB)
    if (UNIX)
        ...
        set(HAILORT_LIB "/opt/poky/4.0.2/sysroots/armv8a-poky-linux/usr/lib/libhailort.so" CACHE FILEPATH "Path to HailoRT library")
    else ()
